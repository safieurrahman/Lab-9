...
function calendar()
{
		...
		document.write('<div class = "tmh">'+months[month]+' '+year+ '</div>');
        document.write('<table class="calendar"><tbody id="body">');
        document.write('<tr><th>Sun</th><th>Mon</th><th>Tue</th><th>Wed</th><th>Thu</th><th>Fri</th><th>Sat</th></tr><tr>');
        week = 0;
        for(i=1;i<=beg_j;i++)
        {
                document.write('<td class="others">'+(days_in_month[month-1]-beg_j+i)+'</td>');
                week++;
        }
        for(i=1;i<=total;i++)
        {
